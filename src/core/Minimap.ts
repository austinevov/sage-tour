...
export default class Minimap {
  ...
  private makeTransform = (): string => {
    ...
    return `translate(${cx}, ${cy}) rotate(${rotationAngle}) translate(-${cx}, -${cy})`;
  };
  ...
  public updateDirectionIndicator = (
    ...
    const correctedTheta =
      this._theta - (this._floorData.byFloor[this._floor] as any).theta;
    ...
    if (point) {
      ...
      const [px, py] = point.floorPosition;
